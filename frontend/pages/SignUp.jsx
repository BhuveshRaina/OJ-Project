...
export default function LoginPage() {
  ...
  return (
    ...
    >
    <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-[50%] flex flex-col items-center space-y-4 sm:min-w-100 sm:w-30%'>
      ...
      >
        ...
        <p className='text-sm text-white text-center'>Already coded here before? <Link
          to="/sign-in"
